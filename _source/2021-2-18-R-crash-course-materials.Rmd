...
- [The R studio IDE](_source/_course-material/cheatsheets/rstudio-ide.pdf);
- [Reading and Writing Data](_source/_course-material/cheatsheets/data-import.pdf);
- Scripting; 
- Packages (and GitHub);
- Ask for help;
...
- Welcome to the [`Tidyverse`](_source/_course-material/cheatsheets/data-transformation.pdf); 
...
- Welcome to [ggplot2](_source/_course-material/cheatsheets/data-visualization-2.1.pdf)
...
- The [`purrr`](_source/_course-material/cheatsheets/data-transformation.pdf) package;

# 5. [Knitting](_source/_course-material/pres/05-rmarkdown.html)

- the [`rmarkdown`](_source/_course-material/cheatsheets/rmarkdown-2.0.pdf) package; 
